...
- **💾 高画質ダウンロード**：処理された画像をワンクリックでダウンロードできます（PNG形式またはJPEG形式）。
- **🌐 多言語対応**：インターフェースは英語、繁體中文、简体中文、日本語、한국어に対応しています。
...
このプロジェクトは研究および学習のみを目的としています。このツールを使用して画像を処理する際は、関連する法律および規制を遵守してください。
